export const content = [
    {
        name: "Manuela e família",
        img: "/testimonials/Manuela.png",
        description: "Não tenho palavras pra agradecer o fato de não me PREOCUPAR com simplesmente nada durante a festa! Foi incrível!  Mi, muito obrigada por tudo, foi um sonho lindo, que Deus abençoe sua vida e que venham muitos trabalhos pela frente! Foi Perfeita a sua entrega!"
    },
    {
        name: "Bruna",
    ...
    },
    {
        ...
        description: "Empresa maravilhosa, nos ajudaram em diversas coisas, conseguiram bons descontos e sempre indicaram fornecedores excelentes!! Obrigado por tudo!"
    },
    {
        name: "Fernanda",
        img: "/testimonials/Fernanda.png",
        description: "Sou ex aluna da Mi, recém-formada no curso de Assessoria e Cerimonial e só tenho a agradecer toda a dedicação e entrega que ela teve comigo... <br /> A Mi é extremamente profissional e objetiva, o método dela ensinar e passar suas experiências é seguro e passa muito do seu conhecimento. <br /> É uma satisfação poder dizer que fui aluna desta grande profissional e espero que muitas outras assessoras possam ter essa oportunidade de amadurecimento e crescimento."
    },
    {
        name: "Rafaela",
        img: "/testimonials/Rafaela.png",
        description: "O Donas do altar foi essencial no nosso evento; a Milene estava em total sincronia conosco, sempre disposta a ajudar em todos os aspectos, muito atenciosa e competente do começo ao fim. <br /> Um casamento possui inúmeros detalhes a serem decididos e planejados ao longo de meses que precisam ser conferidos nas vésperas e no dia do evento para sucesso total da comemoração; portanto faz-se essencial ter uma cerimonialista e sua equipe, e eu indico de olhos fechados o Donas do Altar!!!!"
    },
    {
        name: "Marcela",
        img: "/testimonials/Marcela.png",
        description: "De todas as contratações do nosso casamento, a Donas do Altar foi a melhor. Antes de começarmos a conversar com a Milene estávamos sem foco e não tínhamos ideia da quantidade de coisas que precisam de atenção, mas agora temos todo o evento resolvido a meses ainda da data, com coisas que nem sabíamos que precisávamos ou que queríamos. Nunca mais faço uma festa sem a Donas do Altar."
    },
    {
        name: "Priscila",
    ...
    },
    {
        ...
        description: "Ter contratado a assessoria da Milene, foi o melhor investimento que eu poderia ter feito pro meu casamento. Além dela ser super competente, é uma fofa e me ajuda em tuuuudo, desde escolha do local e do vestido até nas ideias mais mirabolantes. Eu tinha super receio de fazer uma festa de casamento porque não queria o stress e a dor de cabeça de planejar uma. Mas com a Mi, o processo está sendo super tranquilo - além dela conseguir ótimas negociações com os fornecedores. Como resultado, estou 100% tranquila com o dia do casamento em si porque tenho plena confiança de que ela cuidará pra que tudo saia perfeito como eu sempre sonhei."
    },
]